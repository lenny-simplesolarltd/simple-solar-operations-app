...
| `FORMS_LINK_SECRET`             | server | ≥ 32 random characters; derives Forms recipient-link tokens (HMAC). No fallback: without it links cannot be created. Rotating it invalidates every link |
